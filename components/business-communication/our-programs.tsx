                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 max-w-7xl mx-auto">
                        {programs.map((item, idx) => {
                            ...
                            return (
                                <Card
                                    key={idx}
                                    className={`hover:shadow-lg transition-all duration-300 ${borderClass} bg-gradient-to-br to-background relative`}
                                >
                                    <CardContent className="p-8 flex flex-col items-center text-center">
                                        ...
                                        <ul className="text-left text-muted-foreground mb-12">
                                        ...
                                        <Button
                                            ...
                                            size="lg"
                                            className={`${buttonClass} flex col text-white font-semibold px-6 py-2 rounded-full absolute bottom-4`}
                                        >
                                            Explore More
